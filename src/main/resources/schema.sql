create sequence t_account_seq start with 100 increment by 50 minvalue 100;
create sequence t_client_seq start with 100 increment by 50 minvalue 100;
create sequence t_transaction_seq start with 100 increment by 50 minvalue 100;
create sequence t_user_seq start with 100 increment by 50 minvalue 100;
